  ...
  <body>
    ...
    <?php
      ...
      if (isset($_POST) && isset($_POST["delete"]))
      {
        ...
        for ($index = 0; $index < count($delete_word_lines); $index++)
        {
      ...
      <div id="container">
        <section id="dictionary">
          <dl>
            ...
            <dt>
              <input
                type="checkbox" name="delete[]" value="<?= $index ?>" />
              <?= $row[0] ?> :
